...
export default function CompanyDetails({ setCounter, name, searchQuery }) {
  // useLocation()
  let { id } = useParams();
  // let test = "AxUF5bRSz98YOcbzGWm7";
  // const { state } = useContext(GlobalContext);

  // let data = state?.companySearchQueryData.map((i) => {
  //   console.log(i);
  //   // return i.id === test;
  // });
  // console.log(data);
  ...
  //           <p className={styles.stats}>{data.OperatesIn}</p>
  //         </div>
  //         <div className={styles.textGroup}>
  //           <p className={styles.statsHeading}>Founded on</p>
  //           {/* <p className={styles.stats}>{data.FoundedOn}</p> */}
  //         </div>
  //         <div className={styles.textGroup}>
  //           <p className={styles.statsHeading}>Products and services</p>
  //           <p className={styles.stats}>{data.products}+</p>
  //         </div>

  //         <div className={styles.textGroup}>
  //           <p className={styles.statsHeading}>Employees</p>
  //           <p className={styles.stats}>{data.employees}+</p>
  //         </div>
  //         <div className={styles.textGroup}>
  //           <p className={styles.statsHeading}>Revenue</p>
  //           <p className={styles.stats}>{data.revenue}</p>
  //         </div>
  //         <div className={styles.textGroup}>
  //           <p className={styles.statsHeading}>Stock price on today</p>
  //           <p className={styles.stats}>{data.stockPriceToday}</p>
  //         </div>
  //       </Box>
